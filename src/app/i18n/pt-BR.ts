...
export const ptBR: Readonly<Record<MessageKey, string>> = {
  ...
  'event.colony_founded': 'Fundação de uma colônia',
  'event.colony_lost': 'Perda de uma colônia',
  ...
  'verify.inheritance.lead':
    'Um mundo que gasta séculos em indústria e pesquisa consegue sair do planeta e ocupar outro corpo do próprio sistema. Se uma dessas colónias aprende a se bastar antes de o mundo natal cair, a história não acaba com o planeta: a gente passa a ser a da colónia, os estoques recomeçam pequenos, o céu é outro, e o conhecimento atravessa. Esta página refaz esse mundo aqui, no seu navegador: ele funda a colónia no ano {founded}, perde o planeta onde nasceu no ano {ended} e segue em outro lugar a partir do ano {year}. O ano da fundação, o ano da queda, o ano da casa nova e a impressão digital desse primeiro ano são todos conferidos com os valores registrados no repositório — prova de que sobreviver ao próprio mundo é tão reprodutível quanto morrer com ele.',
