...
export const en = {
  ...
  'event.space_era': 'Space age',
  'event.colony_founded': 'New colony',
  'event.colony_lost': 'Colony lost',
  'event.inheritance': 'Inheritance',
  ...
  'debt.title': 'Causal debt',
  'debt.owed': '{value} owed to {origins}',
  'debt.rising': 'growing',
  'debt.falling': 'being repaid',
  'debt.steady': 'unchanged',
  'debt.hint.research': 'Its own research pays this down.',
  ...
  'paradox.deadline': 'Collapses in {years} years unless {value} in debt is cleared.',
  'paradox.lastYear': 'Collapses next year unless {value} in debt is cleared.',
  'paradox.thisYear': 'Collapses this year unless {value} in debt is cleared.',
  'paradox.resolved': 'The debt was cleared. The history holds again.',
  'paradox.collapsed': 'This history collapsed in year {year}, under a paradox it could not repay.',
  'events.title': 'Events',
  ...
  'causal.merge': 'Confluence with {other} in year {year}',
  ...
  'hud.collapse': 'Collapse {panel}',
  'hud.expand': 'Expand {panel}',
  'hud.actions': 'Keep this world',
  'hud.sheet.hidden': 'Panels hidden',
  'hud.sheet.peek': 'Panels half open',
  'hud.sheet.open': 'Panels open',
  'hud.sheet.toggle': '{state} — change the height of the panels',
  'zoom.label': 'Zoom',
  'zoom.in': 'Zoom in',
  'zoom.out': 'Zoom out',
  'zoom.fit': 'Show all',
  ...
  'verify.script.inherited': 'Industry and research, one arrival',
  'verify.inheritance.title': 'A history that outlives its world',
  'verify.inheritance.lead':
    'A world that spends centuries on industry and research can leave its planet and settle another body of its own system. If one of those colonies learns to stand on its own before the home world falls, the history does not end with the planet: the people are the colony’s people, the stores start small, the sky is another one, and the knowledge crosses over. This page re-runs that one world here, in your browser: it founds its colony in year {founded}, loses the planet where it was born in year {ended}, and carries on somewhere else from year {year}. The year of the founding, the year of the fall, the year of the new home and the fingerprint of that first year are all checked against the values recorded in the repository — proof that surviving your own world is as reproducible as dying with it.',
  'verify.inheritance.running': 'Running the world that changes home…',
  'verify.inheritance.passed': 'The inheritance and its fingerprint match in this browser.',
  'verify.inheritance.mismatch': 'The inheritance or its fingerprint differ in this browser.',
  'verify.inheritance.script': 'Industry, research and a debt never repaid',
  'verify.script.merged': 'Two shifts, one confluence',
  'verify.merge.title': 'Two histories that become one',
  'verify.merge.lead':
    'Two histories of the same world can also stop being two. One of them flows into the other: the people arrive, the granaries are added together, every level is averaged by how many people each side brings, the sky is shared, and what one of them still owed the other stops being a debt, because a debt to yourself is not a debt. The history that flows away does not live that year — it stops in it. This page re-runs both here, in your browser: they become one in year {tick}, and the fingerprint of the one that received them is taken in year {year}. The year of the seam, the fate of the history that flowed away, the debt that dissolved and that fingerprint are all checked against the values recorded in the repository — proof that the seam between two worlds is as reproducible as either of them alone.',
  'verify.merge.running': 'Running the two histories that become one…',
  'verify.merge.passed': 'The confluence and its fingerprint match in this browser.',
  'verify.merge.mismatch': 'The confluence or its fingerprint differ in this browser.',
  'verify.merge.script': 'Two shifts and a confluence with a world that owed it',
  ...
  'worlds.merge': 'From history {id}, let it flow into this one',
  'worlds.merged': 'Flowed into {other} in {year}',
  ...
  'system.label': 'The bodies of {seed}',
  'system.exit': 'Back to the currents',
  'system.enter': 'View the system',
  'system.dive': 'Descend to the planet',
  'system.home': '{name} — home',
  'system.natal': '{name} — where the history began',
  'system.dead': '{name} — the world that ended',
  'system.colony': '{name} — {people} settled',
  'system.empty': '{name} — no one there',
  ...
  'merge.title': 'Merge {survivor} with {other}',
  'merge.pick': 'Choose the history that flows into this one',
  ...
  'merge.notNow': '{other} is not in the present year',
